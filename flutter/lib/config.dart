...
List<Map<String, String>> defaultPrompts = [
  ...
  {'id': uuid.v4(), 'title': '😌 Will this be comfortable?', 'prompt': '😌 Will this be comfortable?\nWill I be comfortable in the outfit in the image? I.e. will I be too cold, too hot, or just right?\nThe current temperature is {weather.temp} and the forecast is: {weather.forecast}\n\nRespond in the following format:\n# [Emoji representing anticipated comfort by temperature: 🥶if the user is likely to be too cold, 🙂if they are likely to be comfortable, and 🥵if they are likely to be too hot]\n## Comfort Level\n[1-10/10]\n## Recommendation\n[Guidance, eg “put on a jacket”]\n## Temperature\n[Temperature]\n## Forecast\n[Forecast]'},
