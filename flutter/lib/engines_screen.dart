      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child:
              MarkdownBody(
                data: "Configure custom engines via Open API specification, e.g. connect to open-source, locally hosted, or development models.  \n\nFor examples/docs, visit [https://github.com/alexdredmon/crayeye?tab=readme-ov-file#local+models](https://github.com/alexdredmon/crayeye?tab=readme-ov-file#local-models)",
